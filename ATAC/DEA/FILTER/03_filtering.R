...
global <- unique(c(MM_HC_no, SMM_HC_no, MGUS_HC_no)) #28513
length(global)
...
MM_HC_no_filter <- MM_HC_no[MM_HC_no %in% global] #27323
SMM_HC_filter <- SMM_HC[SMM_HC %in% global] #15839
MGUS_HC_filter <- MGUS_HC[MGUS_HC %in% global] #9402

length(MM_HC_no_filter)
length(SMM_HC_filter)
length(MGUS_HC_filter)
...
save(MM_HC_filter, SMM_HC_filter, MGUS_HC_filter, global, file="final_peaks.RData")