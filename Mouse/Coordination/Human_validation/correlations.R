...
all_genes <- unique(c(MGUS_HC, MM_HC))

orthologs <- orthologs[orthologs$Mouse_ensembl_gene_id%in%all_genes,]
dim(orthologs) # 940

# Load human final genes
...
setwd("/ibex/user/kurowsaa/Riney_project/Mouse/Coordination/Human_validation")
