...
# Plot
setwd("/ibex/user/kurowsaa/Riney_project/Coordination/Gene_OCR/ATAC/PLOTS")
...
# saveWidget(s, file="atac_dea_sankey_network.html")

# # Check index of each category for target and source
# cat("MGUS_Up-regulated:", get_node_index("Up-regulated", "MGUS"), "\n")
# cat("SMM_Up-regulated:", get_node_index("Up-regulated", "SMM"), "\n")
# cat("MM_Up-regulated:", get_node_index("Up-regulated", "MM"), "\n")

# cat("MGUS_Down-regulated:", get_node_index("Down-regulated", "MGUS"), "\n")
# cat("SMM_Down-regulated:", get_node_index("Down-regulated", "SMM"), "\n")
# cat("MM_Down-regulated:", get_node_index("Down-regulated", "MM"), "\n")

# cat("MGUS_Non-differential:", get_node_index("Non-differential", "MGUS"), "\n")
# cat("SMM_Non-differential:", get_node_index("Non-differential", "SMM"), "\n")
# cat("MM_Non-differential:", get_node_index("Non-differential", "MM"), "\n")
...
# saveWidget(ss, file="atac_dea_sankey_network_transition.html")
...
# png("atac_dea_category_barplot_MGUS_SMM.png", width=1500, height=100, res=300)
...
# png("atac_dea_category_barplot_SMM_MM.png", width=1500, height=100, res=300)
# ggplot(category_counts, aes(x = 1, y = percent, fill = Category)) +
#   geom_bar(stat = "identity", width = 1) +
#   # Add % values 
#   geom_text(aes(label = paste0(round(percent,1), "%")), 
