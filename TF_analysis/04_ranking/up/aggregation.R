...
rownames(Rank_MGUS)[1:5]  #"JUND.1" "NFE2"   "FOSL1"  "BACH1"  "FOS" 

# SMM
Rank_SMM <- aggregateRanks(glist = SMM_list, N = nrow(TF_data))
rownames(Rank_SMM)[1:5] # "JUND.1" "NFE2"   "BACH2"  "FOSL1"  "BACH1"

# MM
Rank_MM <- aggregateRanks(glist = MM_list, N = nrow(TF_data))
rownames(Rank_MM)[1:5] # "JUND.1" "BACH1"  "HOXA9"  "ELK4"   "NFE2" 
...
# Save the data
setwd("/ibex/user/kurowsaa/Riney_project/TF_analysis/04_ranking/up")
